...
describe('Testando a função "approvedStudents', () => {
    ...
    describe('quando todas as notas são maiores que o critério de aprovação', () => {
        it('retorna "true"', () => {
            const disciplines = [
    ...
    describe('quando todas as notas são menores que o critério de aprovação', () => {
        it('retorna "false"', () => {
            const disciplines = [
    ...
    describe('quando parte das notas são menores que o critério de aprovação', () => {
        it('retorna "false"', () => {
            const disciplines = [
